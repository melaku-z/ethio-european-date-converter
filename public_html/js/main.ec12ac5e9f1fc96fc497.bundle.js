...
module.exports = __webpack_require__.p + "LICENSE.txt";
...
module.exports = __webpack_require__.p + "humans.txt";

/***/ }),

/***/ "./src/js/dateconverter.js":
/*!*********************************!*\
  !*** ./src/js/dateconverter.js ***!
  \*********************************/
/*! no static exports found */
...
var globalTimeDifference = new Date('December 9, 2012').getTime() - new Date('April 1, 2005').getTime();
...
function toEuropeanDate(ethDate) {
  ...
  if (ethDate.month === 13) {
    var maxDate;
    if (ethDate.year % 4 === 3) maxDate = 6;else maxDate = 5;
    if (ethDate.date > maxDate) {
      var errMsg = 'Pagume Only has ' + maxDate + ' days at year ' + ethDate.year + '. Please select another day.';
      return errMsg;
    }
  }
  for (var count = -8; count < 9; count++) {
    var EngDate = new Date(initialEuropean.getTime() + count * oneDay);
...
module.exports = exports = {
  ethTime: ethTime,
  toEthiopianDateTime: toEthiopianDateTime,
  toEthiopianDateString: toEthiopianDateString,
  toEthiopianDateTimeString: toEthiopianDateTimeString,
  toEuropeanDate: toEuropeanDate,
  toEuropeanDateString: toEuropeanDateString
};

/***/ }),

/***/ "./src/js/dateconverterUI.js":
/*!***********************************!*\
  !*** ./src/js/dateconverterUI.js ***!
  \***********************************/
/*! no static exports found */
...
var _dateconverter = __webpack_require__(/*! ./dateconverter.js */ "./src/js/dateconverter.js");
...
function updateCalculatedEthDateOnPage() {
  var ethDate = dateConverter.toEthiopianDateTime(new Date($('#EuropeanDate').val()));
...
function updateCalculatedEurDateOnPage() {
  var ethDate_Year = parseInt($('#EthYearScroll')[0].value);
  var ethDate_Month = parseInt($('#EthMonthScroll')[0].value);
  var ethDate_Day = parseInt($('#EthDayScroll')[0].value);
  var ethDate = new dateConverter.ethTime(ethDate_Day, ethDate_Month, ethDate_Year, 0, 0, 0);
  var eurDateTime = dateConverter.toEuropeanDate(ethDate);
  var eurDate;
  if (typeof eurDateTime != 'string') eurDate = eurDateTime.toJSON().slice(0, 10);else eurDate = eurDateTime;
...
module.exports = exports = {
  createEventListnersHTML: createEventListnersHTML
};
...
var _dateconverterUI = __webpack_require__(/*! ./dateconverterUI */ "./src/js/dateconverterUI.js");

(0, _dateconverterUI.createEventListnersHTML)();
